...
def main():
    ...
    image_path="./../Dataset/flower_data"
...
def plot_curve(loss_list,acc_list):
    import numpy as np
    import matplotlib.pyplot as plt 
    x=[i for i in range(len(acc_list))] 
    plt.ylim([0.0,1.0])
    plt.plot(x,np.array(acc_list), 'r*-', label='test_acc') 
    plt.plot(x,loss_list,'bo--',label="train_loss") 
